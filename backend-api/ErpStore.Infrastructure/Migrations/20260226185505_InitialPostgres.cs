        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    CedulaRuc = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "text", nullable: true),
                    Email = table.Column<string>(type: "text", nullable: true),
                    LegalMessage = table.Column<string>(type: "text", nullable: true),
                    SriAuth = table.Column<string>(type: "text", nullable: true),
                    Establishment = table.Column<string>(type: "text", nullable: true),
                    PointOfIssue = table.Column<string>(type: "text", nullable: true),
                    ...
                    LastStockAlertDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoteNumber = table.Column<string>(type: "text", nullable: true),
                    IsVoid = table.Column<bool>(type: "boolean", nullable: false),
                    PaymentMethod = table.Column<string>(type: "text", nullable: false),
                    CashRegisterSessionId = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EsPortada = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Artículos electrónicos", true, "Electrónica", null },
                    { 2, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Artículos para el hogar", true, "Hogar", null }
                });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "FirstName", "LastName", "PasswordHash", "Permissions", "Role", "UpdatedAt", "Username" },
                values: new object[] { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@erpstore.com", "Jairo", "CEO", "admin123", "[\"dashboard.view\",\"products.view\",\"products.manage\",\"categories.manage\",\"pos.access\",\"sales.view\",\"sales.void\",\"cash.manage\",\"purchases.view\",\"purchases.manage\",\"suppliers.manage\",\"clients.manage\",\"expenses.manage\",\"reports.view\",\"users.manage\",\"settings.manage\"]", 0, null, "jairo.ceo" });

            migrationBuilder.InsertData(
                table: "Productos",
                columns: new[] { "Id", "Barcode", "CategoryId", "Cost", "CreatedAt", "Description", "DiscountPercentage", "IsActive", "MinStock", "Name", "Price", "SKU", "Stock", "SubcategoryId", "UpdatedAt", "VideoUrl" },
                values: new object[,]
                {
                    { 1, null, 1, 900.00m, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Laptop de alto rendimiento", 0, true, 3, "Laptop Gamer", 1200.00m, "LAP-001", 10, null, null, null },
                    { 2, null, 1, 600.00m, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Teléfono inteligente", 0, true, 3, "Smartphone X", 800.00m, "PHN-001", 20, null, null, null },
                    { 3, null, 2, 30.00m, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Cafetera automática", 0, true, 3, "Cafetera", 50.00m, "CAF-001", 15, null, null, null }
                });
